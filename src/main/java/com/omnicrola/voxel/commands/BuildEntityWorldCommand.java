 ...
 */
@Serializable
public class BuildEntityWorldCommand extends AbstractWorldCommand {

    private UnitPlacement unitPlacement;

    public BuildEntityWorldCommand() {
    }

    public BuildEntityWorldCommand(UnitPlacement unitPlacement) {
